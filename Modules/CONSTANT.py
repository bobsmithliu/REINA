...
ROLES_ID: dict[str, dict[str, int]] = {
    "main": {
        ...
        'Komiya': 734962916415242301,
        'Aida': 734963028277067817,
        'Mukai': 734963101274865664
    },
    "sub": {
        ...
        'Komiya': 734962982806880256,
        'Aida': 734963014402310265,
        'Mukai': 734963132820226169
    },
    "unit": {
        'Bench': 761416498719752252,
        'Keikoto': 761416777006841866,
        'Cider': 761417030103990302
    }
}

GENERAL_ROLEABLES: list[str] = list(ROLES_ID["main"].keys())
UNIT_ROLABLES: list[str] = list(ROLES_ID["unit"].keys())
...
PRONOUNS: dict[str, int] = {
    ...
    'he': 754764503631134881,
    'ask': 754764814655422614
}
